...
The `--dsw-alias-workbench-*` aliases define the data workbench brand (#0F4C9E), darker hover, white foreground and tinted selection background in both appearances.
