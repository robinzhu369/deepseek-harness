...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Kind in ChatNodeKind]: { node: ChatNode<Kind> } }, already taken: assistant-step, command, command-input, compaction, context, manual-compaction, model-retry, modeling-plan, steering, system-prompt, tool-call, turn-error, turn-max-tokens, turn-process, turn-tail, unknown, user, workflow-run',
    ...
    occupants: [
      ...
      'experimental-modeling ModelingChatCard key \'modeling-plan\'',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: conversation, modeling-data, modeling-runs, modeling-skills',
    hookContext: '',
    slotInject: '',
    ...
    occupants: [
      ...
      'experimental-modeling DataPanel key \'modeling-data\'',
      'experimental-modeling SkillsPanel key \'modeling-skills\'',
      'experimental-modeling RunsPanel key \'modeling-runs\'',
    ],
    replaceRisk: 'shadows-shipped-ui',
