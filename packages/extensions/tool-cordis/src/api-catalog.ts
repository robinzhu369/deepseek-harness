...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: '@Remote async testModel(provider: string, model: string, signal: AbortSignal): Promise<ModelProbeResult>',
        description: 'Test a saved provider using a synthetic message through the Harness loop.',
        parameters: [{ name: 'provider', description: 'Registered provider identifier.' }, { name: 'model', description: 'Configured model identifier.' }, { name: 'signal', description: 'Browser cancellation.' }],
...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  },
  {
    ...
    declaration: 'export interface ModelProbeResult {\n    ok: boolean;\n    code: string;\n    durationMs: number;\n    sessionId: string;\n}',
  },
  {
