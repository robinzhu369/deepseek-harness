...
容量实测 1,000,000 × 100 PASS：403,872,329 B CSV，完整 Profile 和 prepared/manifest 导出总耗时 24.971 秒，峰值 RSS 2,865,119,232 B。详见 [容量报告](CAPACITY_REPORT.md)。统一启动、健康检查与停止见 [部署指南](DEPLOYMENT.md)，8～10 分钟彩排见 [演示指南](DEMO_GUIDE.md)，边界见 [已知限制](KNOWN_LIMITATIONS.md)。
